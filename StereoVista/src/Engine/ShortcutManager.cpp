...
std::string KeyBinding::toString() const {
    ...
    if (mouseButton != -1) {
        switch (mouseButton) {
            case GLFW_MOUSE_BUTTON_LEFT: result += "Left Click"; break;
            case GLFW_MOUSE_BUTTON_RIGHT: result += "Right Click"; break;
            case GLFW_MOUSE_BUTTON_MIDDLE: result += "Middle Click"; break;
            default: result += "Mouse " + std::to_string(mouseButton + 1); break;
        }
    } else if (keyCode != -1) {
...
KeyBinding KeyBinding::fromJson(const nlohmann::json& j) {
    KeyBinding binding;
    if (j.contains("keyCode")) binding.keyCode = j["keyCode"];
    if (j.contains("mouseButton")) binding.mouseButton = j["mouseButton"];
    if (j.contains("ctrl")) binding.ctrl = j["ctrl"];
    if (j.contains("alt")) binding.alt = j["alt"];
    if (j.contains("shift")) binding.shift = j["shift"];
    return binding;
}
...
const std::vector<KeyBinding>& ShortcutProfile::getBindings(ShortcutAction action) const {
...
void ShortcutProfile::setBinding(ShortcutAction action, const KeyBinding& binding, int slot) {
    if (slot < 0 || slot > 1) return; // Only support 2 bindings per action
...
std::optional<ShortcutAction> ShortcutProfile::findConflict(const KeyBinding& binding, ShortcutAction excludeAction) const {
...
ShortcutProfile ShortcutProfile::fromJson(const nlohmann::json& j) {
    ...
    if (j.contains("bindings") && j["bindings"].is_object()) {
        for (auto& [actionNameStr, bindingsArray] : j["bindings"].items()) {
            ...
            // If action not found, it's gracefully ignored (missing shortcut handling)
        }
    }
...
ShortcutProfile ShortcutManager::createDefaultProfile() {
    ...
    profile.setBinding(ShortcutAction::DeleteObject, KeyBinding(GLFW_KEY_DELETE), 0);
...
void ShortcutManager::renameProfile(const std::string& oldName, const std::string& newName) {
...
std::optional<ShortcutAction> ShortcutManager::getActionForKey(int key, int mods) const {
...
std::optional<ShortcutAction> ShortcutManager::getActionForMouse(int button, int mods) const {
    const ShortcutProfile* profile = getActiveProfile();
    if (!profile) return std::nullopt;
...
std::string ShortcutManager::getActionName(ShortcutAction action) {
    switch (action) {
        ...
        case ShortcutAction::ToggleGUI: return "ToggleGUI";
        case ShortcutAction::ToggleFPS: return "ToggleFPS";
        case ShortcutAction::ToggleWireframe: return "ToggleWireframe";
        case ShortcutAction::ToggleRadar: return "ToggleRadar";

        // Camera Controls
        case ShortcutAction::CenterView: return "CenterView";
        case ShortcutAction::ToggleZoomToCursor: return "ToggleZoomToCursor";
        case ShortcutAction::ToggleOrbitAroundCursor: return "ToggleOrbitAroundCursor";

        // Lighting
        case ShortcutAction::CycleLighting: return "CycleLighting";
        case ShortcutAction::ToggleShadows: return "ToggleShadows";
        case ShortcutAction::ToggleHDR: return "ToggleHDR";
        case ShortcutAction::ToggleBloom: return "ToggleBloom";
        case ShortcutAction::TogglePCSS: return "TogglePCSS";
        case ShortcutAction::ToggleSunLight: return "ToggleSunLight";

        // Materials & Rendering
        case ShortcutAction::TogglePBR: return "TogglePBR";

        // VCT
        case ShortcutAction::ToggleVoxelViz: return "ToggleVoxelViz";
        case ShortcutAction::ToggleVCTIndirectDiffuse: return "ToggleVCTIndirectDiffuse";
        case ShortcutAction::ToggleVCTIndirectSpecular: return "ToggleVCTIndirectSpecular";
        case ShortcutAction::ToggleVCTDirectLight: return "ToggleVCTDirectLight";
        case ShortcutAction::ToggleVCTSoftShadows: return "ToggleVCTSoftShadows";

        // Raytracing
        case ShortcutAction::ToggleRaytracing: return "ToggleRaytracing";
        case ShortcutAction::ToggleIndirectLighting: return "ToggleIndirectLighting";
        case ShortcutAction::ToggleEmissiveLighting: return "ToggleEmissiveLighting";
        case ShortcutAction::ToggleBVH: return "ToggleBVH";

        // 3D Cursor
        case ShortcutAction::ToggleSphereCursor: return "ToggleSphereCursor";
        case ShortcutAction::ToggleCircleCursor: return "ToggleCircleCursor";
        case ShortcutAction::TogglePlaneCursor: return "TogglePlaneCursor";

        // Window Management
        case ShortcutAction::OpenSettings: return "OpenSettings";
        case ShortcutAction::OpenCursorSettings: return "OpenCursorSettings";
        case ShortcutAction::OpenBrushTool: return "OpenBrushTool";

        // File Operations
        case ShortcutAction::ImportModel: return "ImportModel";
        case ShortcutAction::ImportPointCloud: return "ImportPointCloud";
        case ShortcutAction::SaveScene: return "SaveScene";
        case ShortcutAction::LoadScene: return "LoadScene";

        // Object Manipulation
        case ShortcutAction::DeleteObject: return "DeleteObject";
...
std::string ShortcutManager::getActionDescription(ShortcutAction action) {
    switch (action) {
        // View/Display Controls
        case ShortcutAction::ToggleGUI: return "Toggle GUI Visibility";
        case ShortcutAction::ToggleFPS: return "Toggle FPS Counter";
        case ShortcutAction::ToggleWireframe: return "Toggle Wireframe Mode";
        case ShortcutAction::ToggleRadar: return "Toggle Radar/Mini-Map";

        // Camera Controls
        case ShortcutAction::CenterView: return "Center View on Cursor/Object";
        case ShortcutAction::ToggleZoomToCursor: return "Toggle Zoom to Cursor";
        case ShortcutAction::ToggleOrbitAroundCursor: return "Toggle Orbit Around Cursor";

        // Lighting
        case ShortcutAction::CycleLighting: return "Cycle Lighting Mode";
        case ShortcutAction::ToggleShadows: return "Toggle Shadows";
        case ShortcutAction::ToggleHDR: return "Toggle HDR";
        case ShortcutAction::ToggleBloom: return "Toggle Bloom Effect";
        case ShortcutAction::TogglePCSS: return "Toggle Soft Shadows (PCSS)";
        case ShortcutAction::ToggleSunLight: return "Toggle Sun Light";

        // Materials & Rendering
        case ShortcutAction::TogglePBR: return "Toggle PBR Materials";

        // VCT
        case ShortcutAction::ToggleVoxelViz: return "Toggle Voxel Visualization";
        case ShortcutAction::ToggleVCTIndirectDiffuse: return "Toggle VCT Indirect Diffuse";
        case ShortcutAction::ToggleVCTIndirectSpecular: return "Toggle VCT Indirect Specular";
        case ShortcutAction::ToggleVCTDirectLight: return "Toggle VCT Direct Lighting";
        case ShortcutAction::ToggleVCTSoftShadows: return "Toggle VCT Soft Shadows";

        // Raytracing
        case ShortcutAction::ToggleRaytracing: return "Toggle Raytracing";
        case ShortcutAction::ToggleIndirectLighting: return "Toggle Indirect Lighting";
        case ShortcutAction::ToggleEmissiveLighting: return "Toggle Emissive Lighting";
        case ShortcutAction::ToggleBVH: return "Toggle BVH Acceleration";

        // 3D Cursor
        case ShortcutAction::ToggleSphereCursor: return "Toggle 3D Sphere Cursor";
        case ShortcutAction::ToggleCircleCursor: return "Toggle 2D Circle Cursor";
        case ShortcutAction::TogglePlaneCursor: return "Toggle Surface Plane Cursor";

        // Window Management
        case ShortcutAction::OpenSettings: return "Open Settings Window";
        case ShortcutAction::OpenCursorSettings: return "Open Cursor Settings";
        case ShortcutAction::OpenBrushTool: return "Open Brush Tool Window";

        // File Operations
        case ShortcutAction::ImportModel: return "Import Model";
        case ShortcutAction::ImportPointCloud: return "Import Point Cloud";
        case ShortcutAction::SaveScene: return "Save Scene";
        case ShortcutAction::LoadScene: return "Load Scene";

        // Object Manipulation
        case ShortcutAction::DeleteObject: return "Delete Selected Object";
...
bool ShortcutManager::importProfileFromFile(const std::string& filepath) {
    try {
        ...
        if (j.contains("profiles") && j["profiles"].is_array() && !j["profiles"].empty()) {
...
bool ShortcutManager::exportProfileToFile(const std::string& profileName, const std::string& filepath) const {
    try {
